...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { email: @instructor.email, name: @instructor.name, post_code: @instructor.post_code, telephone_number: @instructor.telephone_number }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { email: @instructor.email, name: @instructor.name, post_code: @instructor.post_code, telephone_number: @instructor.telephone_number }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
